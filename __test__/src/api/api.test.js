...
describe('API', () => {
  ...
  xit('gets a 500 response on an invalid model', () => {
  ...
  xit('gets a 404 response on an invalid access point', () => {
  ...
  xit('gets a 200 response on a good model, with correct response body', () => {
  ...
  xit('gets ID a 200 response on a good model with ID', () => {
  ...
  // xit('DELETES ID a 200 response on a good model with ID', (done) => {
  //   return superagent.post('http://localhost:8888/api/v1/foo/123')
  //     .then(response =>{
  //       console.log;
  //     });
